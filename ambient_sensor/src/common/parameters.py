...
MQTT_RECONNECT_SECONDS = env_value(
    "MQTT_RECONNECT_SECONDS", "mqtt.reconnect_seconds", 5, float
)
...
ENV_PUBLISH_INTERVAL_SECONDS = env_value(
    "ENV_PUBLISH_INTERVAL_SECONDS",
    "simulation.environment_publish_interval_seconds",
    10,
    float,
)
SIMULATION_START_DATE = env_value(
    "SIMULATION_START_DATE", "simulation.start_date", "01/01/2026", str
)
