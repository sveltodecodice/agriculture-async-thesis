...
async def force_irrigation(mqtt_client, current_moisture: float = 0.0, irrigation_amount: float = 25.0, camp_id: str = "fortnite"):
...
async def auto_irrigate(mqtt_client, current_moisture: float, min_moisture: float = 20.0, irrigation_amount: float = 13.0, camp_id: str = "fortnite"):
