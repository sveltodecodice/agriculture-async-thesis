def calculate_oxygenation(current_oxygenation: float, temperature: float, soil_moisture: float) -> float:
...
def apply_reoxygenation(current_oxygenation: float, minimal_oxygenation: float = 20.0, reoxygenation: float = 60.0) -> float:
