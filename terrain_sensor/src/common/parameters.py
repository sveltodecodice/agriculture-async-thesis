...
FIELD_INIT_SOIL_TYPE = field_value(FIELD_NAME, "terrain.soil_type", "FIELD_INIT_TYPE", env_value("SOIL_LAYOUT_MODE", "simulation.soil_layout.mode", "Franco", str), str)
SOIL_LAYOUT_SEED = env_value("SOIL_LAYOUT_SEED", "simulation.soil_layout.seed", 2026, int)
FIELD_INIT_OXYGENATION = field_value(FIELD_NAME, "terrain.initial_oxygenation", "FIELD_INIT_OXY", 70.0, float)
...
HEARTBEAT_TOPIC = f"camp/{FIELD_NAME}/heartbeat/terrain_sensor"
